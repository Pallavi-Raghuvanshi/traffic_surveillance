...
class TrackerBenchmark:
    ...
    def run(self) -> None:
        ...
        self.config["detection"]["algorithm"] = detector_cfg["algorithm"]
        self.config["detection"]["model"] = detector_cfg["model"]
        ...
        for tracker in benchmark_cfg["trackers"]:
            ...
            self.results.append((tracker, summary))
        self._save_summary()
        self._print_summary()
    ...
    def _save_summary(self) -> None:
        ...
        output_file = benchmark_csv_path(
            self.config["benchmark"]["output_directory"], "tracker")
        ...
        with output_file.open(
            ...
            for (tracker, summary) in self.results:
                writer.writerow(
                    [
                        tracker,
